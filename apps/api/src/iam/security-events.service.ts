...
export const SECURITY_EVENT_TYPES = [
  ...
  'BUSINESS_PREPAYMENT_CONFIG_UPDATE',
  ...
  'BOOKING_VERIFICATION_CODE_NO_CHANNEL',
  ...
  // Owner Telegram verification events (Prompt 23, REQ-065/066/067/068/120).
  'TELEGRAM_OWNER_CONNECT_INITIATED',
  'TELEGRAM_OWNER_CONNECTED',
  'TELEGRAM_OWNER_DISCONNECTED',
  'TELEGRAM_OWNER_TOKEN_EXPIRED',
  'TELEGRAM_ACTION_ACCEPTED',
  'TELEGRAM_ACTION_REJECTED',
  'TELEGRAM_ACTION_INVALID',
  'TELEGRAM_ACTION_EXPIRED',
  'TELEGRAM_ACTION_REUSED',
  'TELEGRAM_ACTION_UNAUTHORIZED',
  // Owner dashboard proof retrieval (Prompt 23, REQ-119).
